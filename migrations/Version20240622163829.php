 ...
 */
final class Version20240622163829 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE player_stats (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, name VARCHAR(255) NOT NULL, balance INTEGER DEFAULT NULL, winning INTEGER DEFAULT NULL, bet INTEGER DEFAULT NULL)');
    }
