 ...
 */
final class Version20240510204342 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE book (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, title VARCHAR(255) NOT NULL COLLATE "BINARY", isbn VARCHAR(255) NOT NULL COLLATE "BINARY", author VARCHAR(255) NOT NULL COLLATE "BINARY", image_path VARCHAR(255) DEFAULT NULL COLLATE "BINARY")');
        $this->abortIf(
            !$this->connection->getDatabasePlatform() instanceof \Doctrine\DBAL\Platforms\SqlitePlatform,
            "Migration can only be executed safely on '\Doctrine\DBAL\Platforms\SqlitePlatform'."
        );
